...
X_all_data = np.array(X_all_data).astype(int)
Y_all_data = np.array(Y_all_data).astype(int)
# Data is converted and shuffled here, export
np.savetxt("Data/data.txt", X=X_all_data)
np.savetxt("Data/labels.txt", X=Y_all_data)
